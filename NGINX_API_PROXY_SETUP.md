...
## Задача
Настроить nginx на сервере `drivebit.my` так, чтобы `https://drivebit.my/api/` проксировал запросы на новый бэкенд `http://155.212.170.94:5000/`
...
```bash
NGINX_CONFIG="/etc/nginx/sites-available/drivebit.my"  # или другой путь
...
1. Swagger документация: https://drivebit.my/api/swagger/index.html
2. API endpoints работают через https://drivebit.my/api/
